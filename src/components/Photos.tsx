...
const photos = [
  ...
  { src: facilityNew4, alt: "Удобный подъезд" },
  { src: facilityNew5, alt: "Контейнеры зимой" },
  { src: facilityNew6, alt: "Внутри контейнера" },
  { src: facilityNew7, alt: "Чистый контейнер изнутри" },
  { src: facilityNew8, alt: "Широкий подъезд" },
  { src: facilityNew9, alt: "Видеонаблюдение" },
