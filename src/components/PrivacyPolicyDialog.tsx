        ...
        <ScrollArea className="h-[60vh] pr-4">
          <div className="space-y-6 text-sm text-foreground/90">
            <div>
              ...
              <p className="mb-4">
                Настоящая Политика обработки персональных данных (далее — «Политика») действует в отношении всех персональных данных, которые Индивидуальный предприниматель Никитина-Шин Виктория Викторовна (ОГРНИП 318784700123456, ИНН 780456789012), далее — «Оператор», может получить от пользователей сайта <a href="https://skladnotut.ru" className="text-primary hover:underline">https://skladnotut.ru</a> (далее — «Сайт»).
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mb-2">
                5.1. Обработка осуществляется с применением автоматизации.
              </p>
              <p className="mb-2">
            ...
            <div>
              ...
              <p>
                Данные хранятся до достижения целей обработки, но не менее 1 года, или до отзыва пользователем согласия.
              </p>
            </div>
